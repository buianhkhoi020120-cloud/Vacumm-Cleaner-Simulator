...
class VacuumApp:
    ...
    def run_algorithm(self):
        ...
        # FIX TẠI ĐÂY: Khi bắt đầu chạy, đặt text là "Đang tính toán..." hoặc ẩn đi
    ...
    def animate_step(self):
        ...
        if self.step_idx < len(self.path):
            ...
            # FIX TẠI ĐÂY 1: Bỏ khối status rườm rà ở ô Log, chỉ hiện chữ DONE đơn giản
            self.log("DONE")

            # FIX TẠI ĐÂY 2: Solution Path chỉ xuất hiện đầy đủ khi thuật toán đã chạy xong
